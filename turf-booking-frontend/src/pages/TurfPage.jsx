...
      {slots.length > 0 && (
        <button
          onClick={() => window.location.href = `/turf/${turfId}/book`}
          className="w-full py-2.5 bg-green-600 hover:bg-green-700 text-white font-bold rounded-lg text-xs transition-all"
        >
          Book Now
        </button>
      )}
...
                    <p className="text-lg font-black text-zinc-900">4.9 ⭐</p>
                  </div>
                </div>
              </div>
            </div>
